...
- **Structural SKILL.md validator** — `description + when_to_use ≤ 1536` chars and strict-YAML frontmatter checks shipped with the `skill-management` plugin; the existing commit-time hook now runs the validator on every staged SKILL.md (#TBD)
