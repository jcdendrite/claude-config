...
requirement, including which reporting modes may pool across multiple
`CLAUDE_CONFIG_DIR` accounts or machines. Work that section before
publishing under it. If in doubt, don't.
