...
- **Default length cap is 200 lines** (`check-skill-length.sh`), below Anthropic's documented 500-line ceiling. Shorten first, do not extract: an auxiliary adds Read-tool indirection without reducing context cost.
