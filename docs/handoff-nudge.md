...
| Line prefix | Meaning |
|---|---|
| `nudged session=<id> est=<n> model=<id> window=<n> event=<UserPromptSubmit\|Stop>` | Threshold crossed — first fire or a later re-arm; nudge emitted |
