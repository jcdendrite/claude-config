...
the agent's own diff, run no state-mutating setup commands (the §11 lesson).
...
## 16. check-runner earns its place on verdict quality, not context-cost savings (2026-05-22)

The §10–§14 entries narrowed check-runner's *charter* after operational incidents. This entry re-grounds its *justification* after a measurement.
...
## 17. Single source of truth elevated to a canonical CLAUDE.md rule (2026-05-22)
