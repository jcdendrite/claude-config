...
## 31. `/code-review`'s marker short-circuit left `ready-for-review` untouched (2026-08-24)
...
## 33. `marker.sh check code-review` gains an age bound; `write`/commit-gate stay hash-only (2026-08-24)
