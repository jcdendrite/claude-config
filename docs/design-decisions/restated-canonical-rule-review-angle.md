...
`Restated canonical rule`, scoped to `docs/design-decisions/*.md`, to
catch this pattern at ordinary review cost instead.
...
- [single-source-of-truth-rule.md](single-source-of-truth-rule.md) — the
  rule this angle operationalizes for `docs/design-decisions/*.md`; not
  superseded.
