...
| A11 | Window totals: $5,916.07 (a repeat run minutes later read $5,926.88 — the corpus grows live). Context class 87.4% (cache read 57.9%, write-1h 18.7%, write-5m 10.8%); output 12.6%, input 0.1%. Main 69.3%, subagent 30.7%. | [verified: same run; redaction active, no `STALE PRICING` banner] |
