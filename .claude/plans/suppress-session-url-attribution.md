...
10. **`## 60.` is still the free number** at commit time (row 30 — a manual re-check; this number has already drifted twice before implementation began).
