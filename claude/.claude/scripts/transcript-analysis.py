...
# corpus/cost/denials/pricing/redaction/render/review_trace/reviewer_yield are read only via
# _mod.<module> from test files (unit-testing a private helper, or patching module-owned
