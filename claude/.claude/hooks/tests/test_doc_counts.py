...
_REGISTERED_FACTS: list[DocCountFact] = [
    DocCountFact(
        ...
        occurrences=[
            ...
            Occurrence(
                rel_path="docs/design-decisions/specialist-reviewer-roster.md",
                pattern=r"# Specialist reviewer roster \((\d+) personas\)",
                description="docs/design-decisions/specialist-reviewer-roster.md: heading digit",
            ),
            Occurrence(
                rel_path="docs/design-decisions/specialist-reviewer-roster.md",
                pattern=r"(\w+) stack-specific agents \(CISO,",
                description="docs/design-decisions/specialist-reviewer-roster.md: N stack-specific agents prose",
            ),
            Occurrence(
                rel_path="docs/design-decisions/reviewer-findings-path-output.md",
                pattern=r"All (\w+) reviewer agents write structured",
                description="docs/design-decisions/reviewer-findings-path-output.md: All N reviewer agents prose",
            ),
        ],
    ),
    DocCountFact(
