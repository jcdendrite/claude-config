...
# crosses a measured outlier threshold. See docs/design-decisions.md §59 for
...
# Default 340; see docs/design-decisions.md §59 for the corpus basis.
...
# Default 10; see docs/design-decisions.md §59 for the corpus basis.
...
# Default 2000000; see docs/design-decisions.md §59 for the parsing-speed
