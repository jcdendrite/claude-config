...
# crosses a measured outlier threshold. See docs/design-decisions.md §38 for
...
#   docs/design-decisions.md §38 for the fuller rationale.
...
# Default 340; see docs/design-decisions.md §38 for the corpus basis.
...
# Default 10; see docs/design-decisions.md §38 for the corpus basis.
...
# Default 2000000; see docs/design-decisions.md §38 for the parsing-speed
