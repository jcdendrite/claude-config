...
- **One root problem/threat line** stating what the plan solves.
...
- **Every material assumption gets its own row, tagged:**
  ...
  - `[engineer-verified]` — came from the human directly. Never silently revise or override this tag from your own investigation — a contradiction pauses and asks instead.
