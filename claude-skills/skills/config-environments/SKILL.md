...
5. **Is "environment" conflated with "tenant" or "feature flag"?** Those are different axes. Where the toggle should live, and whether it needs a flag platform, is the `feature-flags` skill's call, not this one's.
